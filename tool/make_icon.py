...
**The letter is I, and Master Prompt's is P.** The two are one family and look
it — same ink, same Inter, same rule — so the initial is the only thing telling
them apart in a taskbar or a launcher, and it has to be the one thing that
differs. This is the same script Master Prompt keeps, with one constant
changed; keeping them in step by hand is the point.
"""
from PIL import Image, ImageDraw, ImageFont

INK = (0x17, 0x18, 0x1A, 255)      # MiColors.light.ink
CANVAS = (0xFB, 0xFB, 0xFA, 255)   # MiColors.light.canvas
FONT = 'packages/mi_design/assets/fonts/Inter-SemiBold.ttf'

# The half of the pair this is. Master Prompt draws the same mark with a P.
LETTER = 'I'
